...
namespace BrnMall.Services
{
    ...
    public class FilterWords
    {
        ...
        {
            return BrnMall.Data.FilterWords.GetFilterWordList();
        }
        ...
        {
            object[,] filterWordRegexList = BrnMall.Core.BMACache.Get(CacheKeys.MALL_FILTERWORD_REGEXLIST) as object[,];
            if (filterWordRegexList == null)
            {
                ...
                BrnMall.Core.BMACache.Insert(CacheKeys.MALL_FILTERWORD_REGEXLIST, filterWordRegexList);
            }

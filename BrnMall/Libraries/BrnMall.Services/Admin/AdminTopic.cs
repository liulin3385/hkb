...
namespace BrnMall.Services
{
    ...
    /// 后台活动专题操作管理类
    /// </summary>
    public class AdminTopic : Topics
    {
        /// <summary>
        /// 创建活动专题
        /// </summary>
        ...
        {
            return BrnMall.Data.Topics.AdminGetTopicListSort(sortColumn, sortDirection);
        }
        ...
        {
            return BrnMall.Data.Topics.AdminGetTopicList(pageSize, pageNumber, condition, sort);
        }

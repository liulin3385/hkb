...
namespace BrnMall.Services
{
    ...
    /// 后台配送公司操作管理类
    /// </summary>
    public class AdminShipCompanies : ShipCompanies
    {
        /// <summary>
        /// 创建配送公司
        /// </summary>
        ...
        public static void UpdateShipCompany(ShipCompanyInfo shipCompanyInfo)
        {
            ...
            BrnMall.Core.BMACache.Remove(CacheKeys.MALL_SHIPCOMPANY_INFO + shipCompanyInfo.ShipCoId);
        }
        ...
        public static void DeleteShipCompanyById(int shipCoId)
        {
            ...
            BrnMall.Core.BMACache.Remove(CacheKeys.MALL_SHIPCOMPANY_INFO + shipCoId);
        }
        ...
        {
            return BrnMall.Data.ShipCompanies.GetShipCoIdByName(shipCoName);
        }
    }
}

...
namespace BrnMall.Services
{
    ...
    /// 后台积分操作管理类
    /// </summary>
    public class AdminCredits : Credits
    {
        /// <summary>
        /// 后台获得积分日志列表
        /// </summary>
        ...
        {
            return BrnMall.Data.Credits.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnMall.Data.Credits.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return BrnMall.Data.Credits.AdminGetCreditLogCount(condition);
        }

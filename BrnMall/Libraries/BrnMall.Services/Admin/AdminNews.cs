...
namespace BrnMall.Services
{
    ...
    public class AdminNews : News
    {
        ...
        {
            return BrnMall.Data.News.AdminGetNewsList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.News.AdminGetNewsListSort(sortColumn, sortDirection);
        }

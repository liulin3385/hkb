...
namespace BrnMall.Services
{
    ...
    /// 后台商品咨询操作管理类
    /// </summary>
    public class AdminProductConsults : ProductConsults
    {
        /// <summary>
        /// 创建商品咨询类型
        /// </summary>
        ...
        {
            return BrnMall.Data.ProductConsults.AdminGetProductConsultList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.ProductConsults.AdminGetProductConsultListCondition(storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return BrnMall.Data.ProductConsults.AdminGetProductConsultListSort(sortColumn, sortDirection);
        }

...
namespace BrnMall.Services
{
    ...
    /// 后台商品评价操作管理类
    /// </summary>
    public class AdminProductReviews : ProductReviews
    {
        /// <summary>
        /// 后台获得商品评价
        /// </summary>
        ...
        {
            return BrnMall.Data.ProductReviews.AdminGetProductReviewList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.ProductReviews.AdminGetProductReviewListSort(sortColumn, sortDirection);
        }

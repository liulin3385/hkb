...
{
    public class AdminSearchHistories : SearchHistories
    {
        /// <summary>
        /// 获得搜索词统计列表
        /// </summary>
        ...
        {
            return BrnMall.Data.SearchHistories.GetSearchWordStatList(pageSize, pageNumber, word, sort);
        }
        ...
        {
            return BrnMall.Data.SearchHistories.GetSearchWordStatListSort(sortColumn, sortDirection);
        }

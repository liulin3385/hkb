...
namespace BrnMall.Services
{
    ...
    /// 后台促销活动操作管理类
    /// </summary>
    public class AdminPromotions : Promotions
    {
        /// <summary>
        /// 后台获得单品促销活动
        /// </summary>
        ...
        {
            return BrnMall.Data.Promotions.AdminGetSinglePromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetSinglePromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetBuySendPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetBuySendPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return BrnMall.Core.BMAData.RDBS.GetStoreIdListByBuySendPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return BrnMall.Core.BMAData.RDBS.GetStoreIdListByBuySendProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetGiftPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetGiftPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            if (pmId > 0 && giftId > 0 && number > 0)
                BrnMall.Data.Promotions.AddGift(pmId, giftId, number);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetGiftListByPmId(pmId);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetSuitPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetSuitPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            if (pmIdList != null && pmIdList.Length > 0)
                return BrnMall.Core.BMAData.RDBS.GetStoreIdListBySuitPmId(CommonHelper.IntArrayToString(pmIdList));
            return new DataTable();
        }
        ...
        {
            if (discount > 0)
                return BrnMall.Data.Promotions.UpdateSuitProductDiscountValue(pmId, pid, discount);
            return false;
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetFullSendPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetFullSendPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return BrnMall.Core.BMAData.RDBS.GetStoreIdListByFullSendProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetFullCutPromotionList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Data.Promotions.AdminGetFullCutPromotionListSort(sortColumn, sortDirection);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return BrnMall.Core.BMAData.RDBS.GetStoreIdListByFullCutProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }

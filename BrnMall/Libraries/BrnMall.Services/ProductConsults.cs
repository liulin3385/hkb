...
namespace BrnMall.Services
{
    ...
    public class ProductConsults
    {
        ...
        {
            ProductConsultTypeInfo[] productConsultTypeList = BrnMall.Core.BMACache.Get(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST) as ProductConsultTypeInfo[];
            if (productConsultTypeList == null)
            {
                productConsultTypeList = BrnMall.Data.ProductConsults.GetProductConsultTypeList();
                BrnMall.Core.BMACache.Insert(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST, productConsultTypeList);
            }
        ...
        {
            BrnMall.Data.ProductConsults.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            BrnMall.Data.ProductConsults.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        {
            if (consultId > 0)
                return BrnMall.Data.ProductConsults.GetProductConsultById(consultId);
            return null;
        }
        ...
        public static void DeleteProductConsultById(int[] consultIdList)
        {
            if (consultIdList != null && consultIdList.Length > 0)
                BrnMall.Data.ProductConsults.DeleteProductConsultById(CommonHelper.IntArrayToString(consultIdList));
        }
        ...
        public static bool UpdateProductConsultState(int consultId, int state)
        {
            if (consultId > 0 && (state == 0 || state == 1))
                return BrnMall.Data.ProductConsults.UpdateProductConsultState(consultId, state);
            return false;
        }
        ...
        {
            return BrnMall.Data.ProductConsults.GetProductConsultList(pageSize, pageNumber, pid, consultTypeId, consultMessage);
        }
        ...
        {
            return BrnMall.Data.ProductConsults.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        {
            return BrnMall.Data.ProductConsults.GetUserProductConsultList(uid, pageSize, pageNumber);
        }
        ...
        {
            return BrnMall.Data.ProductConsults.GetUserProductConsultCount(uid);
        }
    }
}

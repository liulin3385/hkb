...
namespace BrnMall.Services
{
    ...
    public class LoginFailLogs
    {
        ...
        {
            LoginFailLogInfo loginFailLogInfo = BrnMall.Data.LoginFailLogs.GetLoginFailLogByIP(CommonHelper.ConvertIPToInt64(loginIP));
        ...
        {
            BrnMall.Data.LoginFailLogs.AddLoginFailTimes(CommonHelper.ConvertIPToInt64(loginIP), loginTime);
        }
        ...
        {
            BrnMall.Data.LoginFailLogs.DeleteLoginFailLogByIP(CommonHelper.ConvertIPToInt64(loginIP));
        }
    }
}

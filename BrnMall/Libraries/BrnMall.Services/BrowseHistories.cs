...
namespace BrnMall.Services
{
    ...
    public class BrowseHistories
    {
        ...
        {
            return BrnMall.Data.BrowseHistories.GetUserBrowseProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return BrnMall.Data.BrowseHistories.GetUserBrowseProductCount(uid);
        }
        ...
        public static void UpdateBrowseHistory(object state)
        {
            ...
            BrnMall.Data.BrowseHistories.UpdateBrowseHistory(updateBrowseHistoryState.Uid, updateBrowseHistoryState.Pid, updateBrowseHistoryState.UpdateTime);
        }
        ...
        {
            BrnMall.Data.BrowseHistories.ClearExpiredBrowseHistory();
        }
    }
}

...
namespace BrnMall.Services
{
    ...
    public class Brands
    {
        ...
        {
            List<CategoryInfo> categoryList = BrnMall.Core.BMACache.Get(CacheKeys.MALL_BRAND_CATEGORYLIST + brandId) as List<CategoryInfo>;
            if (categoryList == null)
            {
                categoryList = BrnMall.Data.Brands.GetBrandCategoryListByBrandId(brandId);
                BrnMall.Core.BMACache.Insert(CacheKeys.MALL_BRAND_CATEGORYLIST + brandId, categoryList);
            }

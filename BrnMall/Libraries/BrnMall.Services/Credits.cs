...
namespace BrnMall.Services
{
    ...
    public class Credits
    {
        ...
        public static void SendSinglePromotionCredits(ref PartUserInfo partUserInfo, OrderInfo orderInfo, int credits, string promotionName, DateTime sendTime)
        {
            ...
            if (surplusPayCredits != 0)
            {
                ...
                creditLogInfo.ActionDes = "单品促销活动:" + promotionName;
                creditLogInfo.Operator = 0;
        ...
        public static decimal PayCreditsToMoney(int payCredits)
        {
            if (payCredits <= 0)
                return 0M;
            return payCredits / 100 * _creditconfiginfo.PayCreditPrice;
        }

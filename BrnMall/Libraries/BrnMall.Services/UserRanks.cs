...
namespace BrnMall.Services
{
    ...
    public class UserRanks
    {
        ...
        {
            List<UserRankInfo> userRankList = BrnMall.Core.BMACache.Get(CacheKeys.MALL_USERRANK_LIST) as List<UserRankInfo>;
            if (userRankList == null)
            {
                userRankList = BrnMall.Data.UserRanks.GetUserRankList();
                BrnMall.Core.BMACache.Insert(CacheKeys.MALL_USERRANK_LIST, userRankList);
            }
            return userRankList;
        }

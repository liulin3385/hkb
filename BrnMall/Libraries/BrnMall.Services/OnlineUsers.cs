...
namespace BrnMall.Services
{
    ...
    public class OnlineUsers
    {
        ...
        {
            return BrnMall.Data.OnlineUsers.GetOnlineUserList(pageSize, pageNumber, locationType, locationId, sort);
        }
        ...
        {
            return BrnMall.Data.OnlineUsers.GetOnlineUserListSort(sortColumn, sortDirection);
        }

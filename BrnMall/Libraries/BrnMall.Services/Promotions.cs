...
namespace BrnMall.Services
{
    ...
    public class Promotions
    {
        ...
        {
            return BrnMall.Data.Promotions.GetGiftList(pid, nowTime);
        }
        ...
        {
            return BrnMall.Data.Promotions.GetSuitProductList(pmId);
        }
        ...
        {
            return BrnMall.Data.Promotions.GetSuitProductList(storeId, pid, nowTime);
        }
        ...
        {
            return BrnMall.Data.Promotions.GetFullCutPromotionByPmIdAndTime(pmId, nowTime);
        }

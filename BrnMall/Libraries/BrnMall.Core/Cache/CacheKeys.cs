...
namespace BrnMall.Core
{
    ...
    public class CacheKeys
    {
        ...
        /// 属性值信息缓存键
        /// </summary>
        public const string MALL_ATTRIBUTEVALUE_INFO = "/Mall/AttributeValueInfo/";
        /// <summary>
        /// 分类筛选属性及其值列表缓存键
        /// </summary>
        ...
        /// 优惠劵类型发放数量缓存键
        /// </summary>
        public const string MALL_COUPONTYPE_SENDCOUNT = "/Mall/CouponTypeSendCount/";
        ...
        /// 首页banner列表缓存键
        /// </summary>
        public const string MALL_BANNER_HOMELIST = "/Mall/HomeBannerList";
        ...
        /// 配送公司信息缓存键
        /// </summary>
        public const string MALL_SHIPCOMPANY_INFO = "/Mall/ShipCompanyInfo/";
    }
}

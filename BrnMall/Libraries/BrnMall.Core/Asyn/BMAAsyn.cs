...
namespace BrnMall.Core
{
    ...
    public class BMAAsyn
    {
        ...
        /// 异步实例
        /// </summary>
        public static IAsynStrategy AsynInstance
        {
        ...
        private static void LoadAsyn()
        {
            ...
            {
                throw new BMAException("创建\"异步策略对象\"失败，可能存在的原因：未将\"异步策略程序集\"添加到bin目录中；将多个\"异步策略程序集\"添加到bin目录中；\"异步策略程序集\"文件名不符合\"BrnMall.AsynStrategy.{策略名称}.dll\"格式");
            }
        }
    }
}

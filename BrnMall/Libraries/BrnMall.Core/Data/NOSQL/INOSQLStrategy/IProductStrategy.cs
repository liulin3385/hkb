...
{
    /// <summary>
    /// BrnMall非关系型数据库策略之商品接口
    /// </summary>
    public interface IProductNOSQLStrategy
    {
        #region 商品
        ...
        /// 创建部分商品
        /// </summary>
        /// <param name="partProductInfo">部分商品信息</param>
        void CreatePartProduct(PartProductInfo partProductInfo);
        ...
        ///// <returns></returns>
        //List<PartProductInfo> GetPartProductList(string pidList);
        ...
        /// <param name="pid">商品id</param>
        /// <returns></returns>
        List<PartProductInfo> GetRelateProductList(int pid);

        /// <summary>
        /// 创建关联商品列表
        /// </summary>
        /// <param name="pid">商品id</param>
        /// <param name="relateProductList">关联商品列表</param>
        /// <returns></returns>
        void CreateRelateProductList(int pid, List<PartProductInfo> relateProductList);
        ...
        /// <param name="pid">商品id</param>
        /// <returns></returns>
        void ClearRelateProductList(int pid);
        ...
        /// <param name="pidList">商品id列表</param>
        /// <returns></returns>
        void ClearRelateProductList(string pidList);

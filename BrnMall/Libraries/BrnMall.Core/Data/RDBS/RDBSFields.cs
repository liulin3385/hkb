...
namespace BrnMall.Core
{
    ...
    public class RDBSFields
    {
        ...
        /// 广告表
        /// </summary>
        public const string ADVERTS = "[adid],[clickcount],[adposid],[state],[starttime],[endtime],[displayorder],[type],[title],[url],[body]";
        ...
        /// banner表
        /// </summary>
        public const string BANNERS = "[id],[starttime],[endtime],[isshow],[title],[img],[url],[displayorder]";

        /// <summary>
        /// 品牌表
        /// </summary>
        public const string BRANDS = "[brandid],[isshow],[displayorder],[name],[logo]";
        ...
        /// 分类表
        /// </summary>
        public const string CATEGORIES = "[cateid],[isshow],[displayorder],[name],[pricerange],[parentid],[layer],[haschild],[path]";
        ...
        /// 订单商品表
        /// </summary>
        public const string ORDER_PRODUCTS = "[recordid],[oid],[uid],[sid],[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[name],[showimg],[discountprice],[shopprice],[costprice],[marketprice],[weight],[isreview],[realcount],[buycount],[sendcount],[type],[paycredits],[coupontypeid],[extcode1],[extcode2],[extcode3],[extcode4],[extcode5],[extcode6],[extcode7],[extcode8],[extcode9],[extcode10],[extcode11],[extcode12],[extstr1],[extstr2],[extstr3],[extstr4],[ip],[addtime]";
        ...
        /// 订单表
        /// </summary>
        public const string ORDERS = "[oid],[osn],[uid],[orderstate],[productamount],[orderamount],[surplusmoney],[parentid],[addtime],[storeid],[storename],[shipsn],[shipcoid],[shipconame],[shiptime],[paysn],[paysystemname],[payfriendname],[paytime],[regionid],[consignee],[mobile],[phone],[email],[zipcode],[address],[besttime],[shipfee],[payfee],[fullcut],[discount],[paycreditcount],[paycreditmoney],[couponmoney],[weight],[buyerremark],[ip]";
        ...
        /// 店铺表
        /// </summary>
        public const string STORES = "[storeid],[state],[name],[regionid],[storerid],[storeiid],[logo],[createtime],[mobile],[phone],[qq],[ww],[honesties],[stateendtime],[theme],[banner],[announcement],[description]";

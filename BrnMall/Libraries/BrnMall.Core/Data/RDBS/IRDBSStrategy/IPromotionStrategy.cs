...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        void AddGift(int pmId, int giftId, int number);
        ...
        /// <param name="pmId">促销活动id</param>
        /// <returns></returns>
        DataTable AdminGetGiftListByPmId(int pmId);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        DataTable GetGiftList(int pid, DateTime nowTime);
        ...
        /// <returns></returns>
        bool UpdateSuitProductDiscountValue(int pmId, int pid, int discount);
        ...
        /// <param name="pmId">促销活动id</param>
        /// <returns></returns>
        DataTable GetSuitProductList(int pmId);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        DataTable GetSuitProductList(int storeId, int pid, DateTime nowTime);

...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <param name="brandId">品牌id</param>
        /// <returns></returns>
        IDataReader AdminGetBrandById(int brandId);
        ...
        /// <param name="brandName">品牌名称</param>
        /// <returns></returns>
        int AdminGetBrandIdByName(string brandName);
        ...
        /// <param name="brandId">品牌id</param>
        /// <returns></returns>
        IDataReader GetBrandCategoryListByBrandId(int brandId);

        /// <summary>
        /// 隐藏品牌
        /// </summary>
        /// <param name="brandId">品牌id</param>
        void HideBrandById(int brandId);

        /// <summary>
        /// 展示品牌
        /// </summary>
        /// <param name="brandId">品牌id</param>
        void ShowBrandById(int brandId);
        ...
        /// </summary>
        /// <returns></returns>
        IDataReader AdminGetCategoryList();
        ...
        /// </summary>
        /// <param name="cateId">分类id</param>
        void HideCategoryById(int cateId);

        /// <summary>
        /// 展示分类
        /// </summary>
        /// <param name="cateId">分类id</param>
        void ShowCategoryById(int cateId);
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        IDataReader GetCategoryProductList(int pageSize, int pageNumber, string commonCondition, string attrCondition, int onlyStock, string sort);
        ...
        /// <param name="onlyStock">是否只显示有货</param>
        /// <returns></returns>
        int GetCategoryProductCount(string commonCondition, string attrCondition, int onlyStock);
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        IDataReader SearchMallProducts(int pageSize, int pageNumber, string keyword, string commonCondition, string attrCondition, int onlyStock, string sort);
        ...
        /// <param name="onlyStock">是否只显示有货</param>
        /// <returns></returns>
        int GetSearchMallProductCount(string keyword, string commonCondition, string attrCondition, int onlyStock);
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        IDataReader GetStoreClassProductList(int pageSize, int pageNumber, string commonCondition, string sort);
        ...
        /// <param name="commonCondition">普通条件</param>
        /// <returns></returns>
        int GetStoreClassProductCount(string commonCondition);
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        IDataReader SearchStoreProducts(int pageSize, int pageNumber, string keyword, string commonCondition, string sort);
        ...
        /// <param name="commonCondition">普通条件</param>
        /// <returns></returns>
        int GetSearchStoreProductCount(string keyword, string commonCondition);
        ...
        /// <param name="keyword">关键词</param>
        /// <returns></returns>
        IDataReader GetCategoryListByKeyword(string keyword);
        ...
        /// <param name="keyword">关键词</param>
        /// <returns></returns>
        IDataReader GetCategoryBrandListByKeyword(int cateId, string keyword);
        ...
        /// <param name="keywordId">关键词id</param>
        /// <returns></returns>
        int GetPidByKeywordId(int keywordId);
        ...
        /// <param name="keywordIdList">关键词id列表</param>
        /// <returns></returns>
        DataTable GetStoreIdListByKeywordId(string keywordIdList);
        ...
        /// <returns></returns>
        IDataReader GetRelateProductMainPidList(string relatePidList);
        ...
        void AddProductStat(int pid, string category, string value);

        /// <summary>
        /// 更新商品统计
        /// </summary>
        /// <param name="condition">条件</param>
        int UpdateProductStat(string condition);
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        DataTable AdminGetProductConsultList(int pageSize, int pageNumber, string condition, string sort);
        ...
        /// <returns></returns>
        string AdminGetProductConsultListCondition(int storeId, int pid, int uid, string consultMessage, string consultStartTime, string consultEndTime);
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        DataTable GetProductReviewList(int pid, int pageSize, int pageNumber);
        ...
        /// <param name="pid">商品id</param>
        /// <returns></returns>
        int GetProductReviewCount(int pid);

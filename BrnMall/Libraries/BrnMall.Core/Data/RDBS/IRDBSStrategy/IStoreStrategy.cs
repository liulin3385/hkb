...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        DataTable AdminGetStoreList(int pageSize, int pageNumber, string condition, string sort);
        ...
        /// <returns></returns>
        string AdminGetStoreListSort(string sortColumn, string sortDirection);

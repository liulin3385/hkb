...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        DataTable GetHomeBannerList(DateTime nowTime);
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        IDataReader GetShipCompanyList(int pageSize, int pageNumber);

        /// <summary>
        /// 获得配送公司数量
        /// </summary>
        /// <returns></returns>
        int GetShipCompanyCount();
        ...
        /// <returns></returns>
        IDataReader GetShipCompanyById(int shipCoId);
        ...
        /// <returns></returns>
        int GetShipCoIdByName(string shipCoName);

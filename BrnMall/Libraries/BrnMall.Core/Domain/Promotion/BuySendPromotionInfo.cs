...
namespace BrnMall.Core
{
    ...
    /// 买送促销活动信息类
    /// </summary>
    public class BuySendPromotionInfo : IComparable
    {
        ...
        private int _type;//类型0代表全场参加，1代表部分商品参加，2代表部分商品不参加
        ...
        /// <summary>
        /// 类型0代表全场参加，1代表部分商品参加，2代表部分商品不参加
        /// </summary>
        public int Type
        {
            get { return _type; }
        ...
        {
            BuySendPromotionInfo info = (BuySendPromotionInfo)obj;

            if (this.BuyCount > info.BuyCount)
                return 1;
            else if (this.BuyCount < info.BuyCount)
                return -1;
            else
                return 0;
        }

...
namespace BrnMall.Data
{
    ...
    public class OnlineUsers
    {
        ...
        /// </summary>
        private static OnlineUserInfo BuildOnlineUserFromReader(IDataReader reader)
        {
        ...
        public static List<OnlineUserInfo> GetOnlineUserList(int pageSize, int pageNumber, int locationType, int locationId, string sort)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetOnlineUserList(pageSize, pageNumber, locationType, locationId, sort);
            while (reader.Read())
            {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetOnlineUserListSort(sortColumn, sortDirection);
        }

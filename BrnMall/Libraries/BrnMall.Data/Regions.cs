...
namespace BrnMall.Data
{
    ...
    public class Regions
    {
        ...
        /// 构建区域信息
        /// </summary>
        private static RegionInfo BuildRegionFromRow(DataRow row)
        {
        ...
        /// 构建区域信息
        /// </summary>
        private static RegionInfo BuildRegionFromReader(IDataReader reader)
        {
            RegionInfo regionInfo = new RegionInfo();
        ...
        {
            DataTable dt = BrnMall.Core.BMAData.RDBS.GetAllRegion();
        ...
        public static List<RegionInfo> GetRegionList(int parentId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetRegionList(parentId);
            while (reader.Read())
            {
        ...
        public static RegionInfo GetRegionById(int regionId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetRegionById(regionId);
            if (reader.Read())
            {
        ...
        {
            RegionInfo regionInfo = null;
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetRegionByNameAndLayer(name, layer);
            if (reader.Read())
            {
                regionInfo = BuildRegionFromReader(reader);
            }

...
namespace BrnMall.Data
{
    ...
    public class ProductReviews
    {
        ...
        /// </summary>
        private static ProductReviewInfo BuildProductReviewFromReader(IDataReader reader)
        {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetProductReviewList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetProductReviewListSort(sortColumn, sortDirection);
        }
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        public static DataTable GetProductReviewList(int pid, int pageSize, int pageNumber)
        {
            return BrnMall.Core.BMAData.RDBS.GetProductReviewList(pid, pageSize, pageNumber);
        }
        ...
        /// <param name="pid">商品id</param>
        /// <returns></returns>
        public static int GetProductReviewCount(int pid)
        {
            return BrnMall.Core.BMAData.RDBS.GetProductReviewCount(pid);
        }

...
namespace BrnMall.Data
{
    ...
    public class Brands
    {
        ...
        /// </summary>
        private static BrandInfo BuildBrandFromReader(IDataReader reader)
        {
        ...
        /// <param name="brandId">品牌id</param>
        /// <returns></returns>
        public static BrandInfo AdminGetBrandById(int brandId)
        {
            BrandInfo brandInfo = null;
            IDataReader reader = BrnMall.Core.BMAData.RDBS.AdminGetBrandById(brandId);
            if (reader.Read())
            {
                brandInfo = BuildBrandFromReader(reader);
            }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetBrandListSort(sortColumn, sortDirection);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetBrandList(pageSize, pageNumber, condition, sort);
        }
        ...
        /// <param name="brandName">品牌名称</param>
        /// <returns></returns>
        public static int AdminGetBrandIdByName(string brandName)
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetBrandIdByName(brandName);
        }
        ...
        /// <param name="brandId">品牌id</param>
        /// <returns></returns>
        public static List<CategoryInfo> GetBrandCategoryListByBrandId(int brandId)
        {
            List<CategoryInfo> categoryInfoList = new List<CategoryInfo>();
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetBrandCategoryListByBrandId(brandId);
        ...
        /// </summary>
        /// <param name="brandId">品牌id</param>
        public static void HideBrandById(int brandId)
        {
            BrnMall.Core.BMAData.RDBS.HideBrandById(brandId);
        }
        ...
        /// </summary>
        /// <param name="brandId">品牌id</param>
        public static void ShowBrandById(int brandId)
        {
            BrnMall.Core.BMAData.RDBS.ShowBrandById(brandId);
        }

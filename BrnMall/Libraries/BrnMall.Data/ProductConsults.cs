...
namespace BrnMall.Data
{
    ...
    public class ProductConsults
    {
        ...
        /// </summary>
        private static ProductConsultInfo BuildProductConsultFromReader(IDataReader reader)
        {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetProductConsultList(pageSize, pageNumber, condition, sort);
        }
        ...
        /// <returns></returns>
        public static string AdminGetProductConsultListCondition(int storeId, int pid, int uid, string consultMessage, string consultStartTime, string consultEndTime)
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetProductConsultListCondition(storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetProductConsultListSort(sortColumn, sortDirection);
        }

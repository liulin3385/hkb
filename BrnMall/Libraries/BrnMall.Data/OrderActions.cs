...
namespace BrnMall.Data
{
    ...
    public class OrderActions
    {
        ...
        /// </summary>
        private static OrderActionInfo BuildOrderActionFromReader(IDataReader reader)
        {
        ...
        public static List<OrderActionInfo> GetOrderActionList(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderActionList == null)
                {
                    ...
                    IDataReader reader = BrnMall.Core.BMAData.RDBS.GetOrderActionList(oid);
                    while (reader.Read())
                    {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetOrderIdList(startTime, endTime, orderActionType);
        }
    }
}

...
namespace BrnMall.Data
{
    ...
    public class ShipAddresses
    {
        ...
        /// 构建用户配送地址信息
        /// </summary>
        private static ShipAddressInfo BuildShipAddressFromReader(IDataReader reader)
        {
        ...
        /// 构建完整用户配送地址信息
        /// </summary>
        private static FullShipAddressInfo BuildFullShipAddressFromReader(IDataReader reader)
        {
        ...
        public static int CreateShipAddress(ShipAddressInfo shipAddressInfo)
        {
            ...
            if (_ordernosql != null)
                _ordernosql.DeleteFullShipAddressList(shipAddressInfo.Uid);
            return saId;
        }
        ...
        public static List<FullShipAddressInfo> GetFullShipAddressList(int uid)
        {
            ...
            if (_ordernosql != null)
            {
                fullShipAddressList = _ordernosql.GetFullShipAddressList(uid);
                if (fullShipAddressList == null)
                {
                    ...
                    reader.Close();
                    _ordernosql.CreateFullShipAddressList(uid, fullShipAddressList);
                }
            }
            else
            {
        ...
        public static int GetShipAddressCount(int uid)
        {
            ...
            return BrnMall.Core.BMAData.RDBS.GetShipAddressCount(uid);
        }
        ...
        public static FullShipAddressInfo GetDefaultFullShipAddress(int uid)
        {
            ...
            {
                IDataReader reader = BrnMall.Core.BMAData.RDBS.GetDefaultFullShipAddress(uid);
                if (reader.Read())
                {
        ...
        {
            bool result = BrnMall.Core.BMAData.RDBS.DeleteShipAddress(saId, uid);
            if (_ordernosql != null)
                _ordernosql.DeleteShipAddress(saId, uid);
            return result;
        }
        ...
        {
            bool result = BrnMall.Core.BMAData.RDBS.UpdateShipAddressIsDefault(saId, uid, isDefault);
            if (_ordernosql != null)
                _ordernosql.UpdateShipAddressIsDefault(saId, uid, isDefault);
            return result;
        }
    }
}

...
namespace BrnMall.Data
{
    ...
    public class News
    {
        ...
        /// </summary>
        private static NewsTypeInfo BuildNewsTypeFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static NewsInfo BuildNewsFromReader(IDataReader reader)
        {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetNewsList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetNewsListSort(sortColumn, sortDirection);
        }

...
namespace BrnMall.Data
{
    ...
    public class Topics
    {
        ...
        /// </summary>
        private static TopicInfo BuildTopicFromReader(IDataReader reader)
        {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetTopicListSort(sortColumn, sortDirection);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetTopicList(pageSize, pageNumber, condition, sort);
        }

...
namespace BrnMall.Data
{
    ...
    public class Credits
    {
        ...
        /// </summary>
        private static CreditLogInfo BuildCreditLogFromReader(IDataReader reader)
        {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetTodaySendPayCredits(uid, today);
        }
        ...
        public static List<CreditLogInfo> GetPayCreditLogList(int uid, int type, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetPayCreditLogList(uid, type, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetPayCreditLogCount(uid, type);
        }

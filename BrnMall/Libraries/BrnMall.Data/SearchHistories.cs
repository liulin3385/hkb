...
namespace BrnMall.Data
{
    ...
    public class SearchHistories
    {
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateSearchHistory(uid, word, updateTime);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.ClearExpiredSearchHistory();
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetSearchWordStatList(pageSize, pageNumber, word, sort);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetSearchWordStatListSort(sortColumn, sortDirection);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetSearchWordStatCount(word);
        }
    }
}

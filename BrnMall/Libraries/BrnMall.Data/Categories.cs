...
namespace BrnMall.Data
{
    ...
    public class Categories
    {
        ...
        /// </summary>
        private static CategoryInfo BuildCategoryFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static AttributeGroupInfo BuildAttributeGroupFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static AttributeInfo BuildAttributeFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static AttributeValueInfo BuildAttributeValueFromReader(IDataReader reader)
        {
        ...
        public static List<CategoryInfo> GetCategoryList()
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetCategoryList();
            while (reader.Read())
            {
        ...
        {
            List<CategoryInfo> categoryList = new List<CategoryInfo>();
            IDataReader reader = BrnMall.Core.BMAData.RDBS.AdminGetCategoryList();
            while (reader.Read())
            {
                CategoryInfo categoryInfo = BuildCategoryFromReader(reader);
                categoryList.Add(categoryInfo);
        ...
        {
            BrnMall.Core.BMAData.RDBS.DeleteCategoryById(cateId);
        }
        ...
        public static List<BrandInfo> GetCategoryBrandList(int cateId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetCategoryBrandList(cateId);
        ...
        /// </summary>
        /// <param name="cateId">分类id</param>
        public static void HideCategoryById(int cateId)
        {
            BrnMall.Core.BMAData.RDBS.HideCategoryById(cateId);
        }
        ...
        /// </summary>
        /// <param name="cateId">分类id</param>
        public static void ShowCategoryById(int cateId)
        {
            BrnMall.Core.BMAData.RDBS.ShowCategoryById(cateId);
        }
        ...
        public static List<AttributeGroupInfo> GetAttributeGroupListByCateId(int cateId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetAttributeGroupListByCateId(cateId);
            while (reader.Read())
            {
        ...
        public static AttributeGroupInfo GetAttributeGroupById(int attrGroupId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetAttributeGroupById(attrGroupId);
            if (reader.Read())
            {
        ...
        {
            BrnMall.Core.BMAData.RDBS.DeleteAttributeGroupById(attrGroupId);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetAttrGroupIdByCateIdAndName(cateId, name);
        }
        ...
        public static List<AttributeInfo> GetAttributeListByCateId(int cateId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetAttributeListByCateId(cateId);
            while (reader.Read())
            {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetAttributeList(cateId, sort);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetAttributeListSort(sortColumn, sortDirection);
        }
        ...
        {
            List<AttributeInfo> attributeList = new List<AttributeInfo>();
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetFilterAttributeListByCateId(cateId);
            while (reader.Read())
            {
                AttributeInfo attributeInfo = BuildAttributeFromReader(reader);
                attributeList.Add(attributeInfo);
        ...
        public static AttributeInfo GetAttributeById(int attrId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetAttributeById(attrId);
            if (reader.Read())
            {
        ...
        {
            BrnMall.Core.BMAData.RDBS.DeleteAttributeById(attrId);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetAttrIdByCateIdAndName(cateId, attributeName);
        }
        ...
        public static List<AttributeValueInfo> GetAttributeValueListByAttrId(int attrId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetAttributeValueListByAttrId(attrId);
            while (reader.Read())
            {
        ...
        public static AttributeValueInfo GetAttributeValueById(int attrValueId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetAttributeValueById(attrValueId);
            if (reader.Read())
            {
        ...
        {
            BrnMall.Core.BMAData.RDBS.CreateAttributeValue(attributeValueInfo);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.DeleteAttributeValueById(attrValueId);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateAttributeValue(attributeValueInfo);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetAttributeValueIdByAttrIdAndValue(attrId, attrValue);
        }
    }
}

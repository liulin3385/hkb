...
namespace BrnMall.Data
{
    ...
    public class OrderRefunds
    {
        ...
        /// </summary>
        private static OrderRefundInfo BuildOrderRefundFromReader(IDataReader reader)
        {
        ...
        {
            BrnMall.Core.BMAData.RDBS.RefundOrder(refundId, refundSN, refundSystemName, refundFriendName, refundTime);
        }

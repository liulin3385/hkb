...
namespace BrnMall.Data
{
    ...
    public class LoginFailLogs
    {
        ...
        /// <returns></returns>
        public static LoginFailLogInfo GetLoginFailLogByIP(Int64 loginIP)
        {
        ...
        public static void AddLoginFailTimes(Int64 loginIP, DateTime loginTime)
        {
        ...
        /// </summary>
        /// <param name="loginIP">登陆IP</param>
        public static void DeleteLoginFailLogByIP(Int64 loginIP)
        {

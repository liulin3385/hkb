...
namespace BrnMall.Data
{
    ...
    public class Orders
    {
        ...
        public static OrderProductInfo GetOrderProductByRecordId(int recordId)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetOrderProductByRecordId(recordId);
            if (reader.Read())
            {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetCartProductCount(uid);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetCartProductCount(sid);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AddOrderProduct(orderProductInfo);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateOrderProduct(orderProductInfo);
        }
        ...
        public static List<OrderProductInfo> GetCartProductList(int uid)
        {
            ...
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetCartProductList(uid);
            while (reader.Read())
            {
        ...
        {
            List<OrderProductInfo> orderProductList = new List<OrderProductInfo>();
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetCartProductList(sid);
            while (reader.Read())
            {
                OrderProductInfo orderProductInfo = BuildOrderProductFromReader(reader);
                orderProductList.Add(orderProductInfo);
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateCartUidBySid(uid, sid);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.DeleteOrderProductByRecordId(recordIdList);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.ClearCart(uid);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.ClearCart(sid);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateOrderProductCount(recordId, realCount, buyCount);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateFullCutPromotionOfOrderProduct(recordIdList, limitMoney, cutMoney);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.ClearExpiredCart(expireTime);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.CreateOrder(orderInfo);
        }
        ...
        {
            if (_ordernosql != null)
                return GetOrderByOid(oid).OrderState;
            return BrnMall.Core.BMAData.RDBS.GetOrderStateByOid(oid);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetOrderList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetOrderListSort(sortColumn, sortDirection);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.UpdateOrderDiscount(oid, discount, orderAmount, surplusMoney);
            if (_ordernosql != null)
        ...
        public static void SendOrderProduct(int oid, OrderState orderState, string shipSN, int shipCoId, string shipCoName, DateTime shipTime)
        {
            ...
            //if (_ordernosql != null)
            //    _ordernosql.SendOrderProduct(oid, orderState, shipSN);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.PayOrder(oid, orderState, paySN, payTime);
            if (_ordernosql != null)
                _ordernosql.PayOrder(oid, orderState, paySN);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetSaleProductList(pageSize, pageNumber, startTime, endTime);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetSaleProductCount(startTime, endTime);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.GetSaleTrend(trendType, timeType, startTime, endTime);
        }
    }
}

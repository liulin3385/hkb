...
namespace BrnMall.Data
{
    ...
    public class Stores
    {
        ...
        /// </summary>
        private static StoreInfo BuildStoreFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static StoreShipTemplateInfo BuildStoreShipTemplateFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static StoreShipFeeInfo BuildStoreShipFeeFromReader(IDataReader reader)
        {
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetStoreList(pageSize, pageNumber, condition, sort);
        }
        ...
        {
            return BrnMall.Core.BMAData.RDBS.AdminGetStoreListSort(sortColumn, sortDirection);
        }
        ...
        {
            BrnMall.Core.BMAData.RDBS.DeleteStoreById(storeId);
        }

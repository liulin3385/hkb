...
namespace BrnMall.Data
{
    ...
    public class Coupons
    {
        ...
        /// </summary>
        private static CouponTypeInfo BuildCouponTypeFromReader(IDataReader reader)
        {
        ...
        /// </summary>
        private static CouponInfo BuildCouponFromReader(IDataReader reader)
        {
        ...
        /// <param name="couponTypeId">The coupon type identifier.</param>
        /// <returns></returns>

...
namespace BrnMall.RDBSStrategy.SqlServer
{
    ...
    public partial class RDBSStrategy : IRDBSStrategy
    {
        ...
        /// <param name="brandId">品牌id</param>
        /// <returns></returns>
        public IDataReader AdminGetBrandById(int brandId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@brandid", SqlDbType.Int,4,brandId)
                                    };
            string commandText = string.Format("SELECT {1} FROM [{0}brands] WHERE [brandid]=@brandid",
        ...
        {
            DbParameter[] parms = {
                                        GenerateInParam("@isshow", SqlDbType.TinyInt,1,brandInfo.IsShow),
            ...
            string commandText = string.Format("INSERT INTO [{0}brands]([isshow],[displayorder],[name],[logo]) VALUES(@isshow,@displayorder,@name,@logo)",
                                                RDBSHelper.RDBSTablePre);
        ...
        public void DeleteBrandById(int brandId)
        {
            ...
            string commandText = string.Format(@"DELETE FROM [{0}productimages] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [brandid]=@brandid);
                                                 DELETE FROM [{0}productattributes] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [brandid]=@brandid);
                                                 DELETE FROM [{0}productskus] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [brandid]=@brandid);
                                                 DELETE FROM [{0}productstats] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [brandid]=@brandid);
                                                 DELETE FROM [{0}productstocks] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [brandid]=@brandid);
                                                 DELETE FROM [{0}products] WHERE [brandid]=@brandid;
                                                 DELETE FROM [{0}brands] WHERE [brandid]=@brandid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public void UpdateBrand(BrandInfo brandInfo)
        {
            ...
            string commandText = string.Format("UPDATE [{0}brands] SET [isshow]=@isshow,[displayorder]=@displayorder,[name]=@name,[logo]=@logo WHERE [brandid]=@brandid",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        /// <param name="brandName">品牌名称</param>
        /// <returns></returns>
        public int AdminGetBrandIdByName(string brandName)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@name", SqlDbType.NChar, 20, brandName)
                                    };
        ...
        /// <param name="brandId">品牌id</param>
        /// <returns></returns>
        public IDataReader GetBrandCategoryListByBrandId(int brandId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@brandid", SqlDbType.Int, 4, brandId)    
                                    };
            return RDBSHelper.ExecuteReader(CommandType.StoredProcedure,
                                            string.Format("{0}getbrandcategorylistbybrandid", RDBSHelper.RDBSTablePre),
                                            parms);
        }
        ...
        /// </summary>
        /// <param name="brandId">品牌id</param>
        public void HideBrandById(int brandId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@brandid", SqlDbType.Int, 4, brandId)    
                                    };
            string commandText = string.Format("UPDATE [{0}products] SET [state]=3 WHERE [brandid]=@brandid;UPDATE [{0}brands] SET [isshow]=0 WHERE [brandid]=@brandid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        /// </summary>
        /// <param name="brandId">品牌id</param>
        public void ShowBrandById(int brandId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@brandid", SqlDbType.Int, 4, brandId)    
                                    };
            string commandText = string.Format("UPDATE [{0}products] SET [state]=1 WHERE [brandid]=@brandid;UPDATE [{0}brands] SET [isshow]=1 WHERE [brandid]=@brandid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        {
            string commandText = string.Format("SELECT {1} FROM [{0}categories] WHERE [isshow]=1 ORDER BY [displayorder] DESC",
                                                RDBSHelper.RDBSTablePre,
        ...
        /// </summary>
        /// <returns></returns>
        public IDataReader AdminGetCategoryList()
        {
        ...
        {
            DbParameter[] parms = {
                                        GenerateInParam("@isshow", SqlDbType.TinyInt,1, categoryInfo.IsShow),
            ...
            string commandText = string.Format("INSERT INTO [{0}categories]([isshow],[displayorder],[name],[pricerange],[parentid],[layer],[haschild],[path]) VALUES(@isshow,@displayorder,@name,@pricerange,@parentid,@layer,@haschild,@path);SELECT SCOPE_IDENTITY()",
                                                RDBSHelper.RDBSTablePre);
        ...
        public void DeleteCategoryById(int cateId)
        {
            ...
            string commandText = string.Format(@"DELETE FROM [{0}productimages] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [cateid]=@cateid);
                                                 DELETE FROM [{0}productattributes] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [cateid]=@cateid);
                                                 DELETE FROM [{0}productskus] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [cateid]=@cateid);
                                                 DELETE FROM [{0}productstats] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [cateid]=@cateid);
                                                 DELETE FROM [{0}productstocks] WHERE [pid] IN (SELECT [pid] FROM [{0}products] WHERE [cateid]=@cateid);
                                                 DELETE FROM [{0}products] WHERE [cateid]=@cateid;
                                                 DELETE FROM [{0}attributevalues] WHERE [attrid] IN (SELECT [attrid] FROM [{0}attributes] WHERE [cateid]=@cateid);
                                                 DELETE FROM [{0}attributes] WHERE [cateid]=@cateid;
                                                 DELETE FROM [{0}attributegroups] WHERE [cateid]=@cateid;
                                                 DELETE FROM [{0}categories] WHERE [cateid]=@cateid",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public void UpdateCategory(CategoryInfo categoryInfo)
        {
            ...
            string commandText = string.Format("UPDATE [{0}categories] SET [isshow]=@isshow,[displayorder]=@displayorder,[name]=@name,[pricerange]=@pricerange,[parentId]=@parentId,[layer]=@layer,[haschild]=@haschild,[path]=@path WHERE [cateid]=@cateid",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        /// </summary>
        /// <param name="cateId">分类id</param>
        public void HideCategoryById(int cateId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@cateid", SqlDbType.SmallInt, 2, cateId)    
                                    };
            string commandText = string.Format("UPDATE [{0}products] SET [state]=4 WHERE [cateid]=@cateid;UPDATE [{0}categories] SET [isshow]=0 WHERE [cateid]=@cateid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        /// </summary>
        /// <param name="cateId">分类id</param>
        public void ShowCategoryById(int cateId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@cateid", SqlDbType.SmallInt, 2, cateId)    
                                    };
            string commandText = string.Format("UPDATE [{0}products] SET [state]=1 WHERE [cateid]=@cateid;UPDATE [{0}categories] SET [isshow]=1 WHERE [cateid]=@cateid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public void DeleteAttributeGroupById(int attrGroupId)
        {
            ...
            string commandText = string.Format(@"DELETE FROM [{0}productattributes] WHERE [attrid] IN (SELECT [attrid] FROM [{0}attributes] WHERE [attrgroupid]=@attrgroupid);
                                                 DELETE FROM [{0}productskus] WHERE [attrid] IN (SELECT [attrid] FROM [{0}attributes] WHERE [attrgroupid]=@attrgroupid);
                                                 DELETE FROM [{0}attributevalues] WHERE [attrgroupid]=@attrgroupid;
                                                 DELETE FROM [{0}attributes] WHERE [attrgroupid]=@attrgroupid;
                                                 DELETE FROM [{0}attributegroups] WHERE [attrgroupid]=@attrgroupid",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public int GetAttrGroupIdByCateIdAndName(int cateId, string name)
        {
            ...
            string commandText = string.Format("SELECT [attrgroupid] FROM [{0}attributegroups] WHERE [cateid]=@cateid AND [name]=@name",
                                                RDBSHelper.RDBSTablePre);
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteDataset(CommandType.Text, commandText, parms), -1);
        }
        ...
        public void CreateAttribute(AttributeInfo attributeInfo, int attrGroupId, string attrGroupName, int attrGroupDisplayOrder)
        {
            ...
            if (attrId > 0)
            {
                commandText = string.Format("INSERT INTO [{0}attributevalues]([attrgroupid],[attrgroupname],[attrgroupdisplayorder],[attrid],[attrname],[attrdisplayorder],[attrvalue],[isinput],[attrvaluedisplayorder],[attrshowtype]) VALUES({1},'{2}',{3},{4},'{5}',{6},'手动输入',1,0,{7})",
                                             RDBSHelper.RDBSTablePre,
                                             attrGroupId,
                                             attrGroupName,
        ...
        public void DeleteAttributeById(int attrId)
        {
            ...
            string commandText = string.Format(@"DELETE FROM [{0}productattributes] WHERE [attrid]=@attrid;
                                                 DELETE FROM [{0}productskus] WHERE [attrid]=@attrid;
                                                 DELETE FROM [{0}attributevalues] WHERE [attrid]=@attrid;
                                                 DELETE FROM [{0}attributes] WHERE [attrid]=@attrid",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public int GetAttrIdByCateIdAndName(int cateId, string attributeName)
        {
            ...
            string commandText = string.Format("SELECT [attrid] FROM [{0}attributes] WHERE [cateid]=@cateid AND [name]=@name",
                                               RDBSHelper.RDBSTablePre);
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteReader(CommandType.Text, commandText, parms), -1);
        }
        ...
        public void CreateAttributeValue(AttributeValueInfo attributeValueInfo)
        {
            ...
            string commandText = string.Format("INSERT INTO [{0}attributevalues]([attrgroupid],[attrgroupname],[attrgroupdisplayorder],[attrid],[attrname],[attrdisplayorder],[attrvalue],[isinput],[attrvaluedisplayorder],[attrshowtype]) VALUES(@attrgroupid,@attrgroupname,@attrgroupdisplayorder,@attrid,@attrname,@attrdisplayorder,@attrvalue,@isinput,@attrvaluedisplayorder,@attrshowtype)",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public void DeleteAttributeValueById(int attrValueId)
        {
            ...
            string commandText = string.Format(@"DELETE FROM [{0}productattributes] WHERE [attrvalueid]=@attrvalueid;
                                                 DELETE FROM [{0}productskus] WHERE [attrvalueid]=@attrvalueid;
                                                 DELETE FROM [{0}attributevalues] WHERE [attrvalueid]=@attrvalueid;",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public void UpdateAttributeValue(AttributeValueInfo attributeValueInfo)
        {
            ...
            string commandText = string.Format("UPDATE [{0}attributevalues] SET [attrgroupid]=@attrgroupid,[attrgroupname]=@attrgroupname,[attrgroupdisplayorder]=@attrgroupdisplayorder,[attrid]=@attrid,[attrname]=@attrname,[attrdisplayorder]=@attrdisplayorder,[attrvalue]=@attrvalue,[isinput]=@isinput,[attrvaluedisplayorder]=@attrvaluedisplayorder,[attrshowtype]=@attrshowtype WHERE [attrvalueid]=@attrvalueid",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        public DataTable AdminGetProductList(int pageSize, int pageNumber, string condition, string sort)
        {
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pid],[temp1].[storeid],[temp1].[name] AS [pname],[temp1].[shopprice],[temp1].[marketprice],[temp1].[state],[temp1].[isbest],[temp1].[ishot],[temp1].[isnew],[temp1].[displayorder],[temp2].[number],[temp3].[name] AS [sname] FROM (SELECT TOP {0} [pid],[storeid],[name],[shopprice],[marketprice],[state],[isbest],[ishot],[isnew],[displayorder] FROM [{1}products] WHERE [pid] NOT IN (SELECT TOP {3} [pid] FROM [{1}products] ORDER BY {2}) ORDER BY {2}) AS [temp1] LEFT JOIN [{1}productstocks] AS [temp2] ON [temp1].[pid]=[temp2].[pid] LEFT JOIN [{1}stores] AS [temp3] ON [temp1].[storeid]=[temp3].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize);
                else
                    commandText = string.Format("SELECT [temp1].[pid],[temp1].[storeid],[temp1].[name] AS [pname],[temp1].[shopprice],[temp1].[marketprice],[temp1].[state],[temp1].[isbest],[temp1].[ishot],[temp1].[isnew],[temp1].[displayorder],[temp2].[number],[temp3].[name] AS [sname] FROM (SELECT TOP {0} [pid],[storeid],[name],[shopprice],[marketprice],[state],[isbest],[ishot],[isnew],[displayorder] FROM [{1}products] WHERE [pid] NOT IN (SELECT TOP {3} [pid] FROM [{1}products] WHERE {4} ORDER BY {2}) AND {4} ORDER BY {2}) AS [temp1] LEFT JOIN [{1}productstocks] AS [temp2] ON [temp1].[pid]=[temp2].[pid] LEFT JOIN [{1}stores] AS [temp3] ON [temp1].[storeid]=[temp3].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize,
        ...
        {
            string commandText = string.Format(@"DELETE FROM [{0}productstats] WHERE [pid] IN ({1});
        ...
        {
            string commandText = string.Format("UPDATE [{0}products] SET [reviewcount]=[reviewcount]+1,[star{1}]=[star{1}]+1 WHERE [pid]=@pid",
                                                RDBSHelper.RDBSTablePre,
                                                starType);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText);
        }
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        public IDataReader GetCategoryProductList(int pageSize, int pageNumber, string commonCondition, string attrCondition, int onlyStock, string sort)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@pagesize", SqlDbType.Int, 4, pageSize),
                                        GenerateInParam("@pagenumber", SqlDbType.Int, 4, pageNumber),
                                        GenerateInParam("@commoncondition", SqlDbType.NVarChar, 1000, commonCondition),
                                        GenerateInParam("@attrcondition", SqlDbType.NVarChar, 1000, attrCondition),
                                        GenerateInParam("@onlystock", SqlDbType.Int, 4, onlyStock),
                                        GenerateInParam("@sort", SqlDbType.NVarChar, 1000, sort)
                                    };
            return RDBSHelper.ExecuteReader(CommandType.StoredProcedure,
                                            string.Format("{0}getcategoryproductlist", RDBSHelper.RDBSTablePre),
                                            parms);
        }
        ...
        /// <param name="onlyStock">是否只显示有货</param>
        /// <returns></returns>
        public int GetCategoryProductCount(string commonCondition, string attrCondition, int onlyStock)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@commoncondition", SqlDbType.NVarChar, 1000, commonCondition),
                                        GenerateInParam("@attrcondition", SqlDbType.NVarChar, 1000, attrCondition),
            ...
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteScalar(CommandType.StoredProcedure,
                                                                   string.Format("{0}getcategoryproductcount", RDBSHelper.RDBSTablePre),
                                                                   parms));
        }
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        public IDataReader SearchMallProducts(int pageSize, int pageNumber, string keyword, string commonCondition, string attrCondition, int onlyStock, string sort)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@pagesize", SqlDbType.Int, 4, pageSize),
                                        GenerateInParam("@pagenumber", SqlDbType.Int, 4, pageNumber),
                                        GenerateInParam("@keyword", SqlDbType.NChar, 20, keyword),
                                        GenerateInParam("@commoncondition", SqlDbType.NVarChar, 1000, commonCondition),
                                        GenerateInParam("@attrcondition", SqlDbType.NVarChar, 1000, attrCondition),
                                        GenerateInParam("@onlystock", SqlDbType.Int, 4, onlyStock),
                                        GenerateInParam("@sort", SqlDbType.NVarChar, 1000, sort)
            ...
            return RDBSHelper.ExecuteReader(CommandType.StoredProcedure,
                                            string.Format("{0}searchmallproducts", RDBSHelper.RDBSTablePre),
                                            parms);
        }
        ...
        /// <param name="onlyStock">是否只显示有货</param>
        /// <returns></returns>
        public int GetSearchMallProductCount(string keyword, string commonCondition, string attrCondition, int onlyStock)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@keyword", SqlDbType.NChar, 20, keyword),
                                        GenerateInParam("@commoncondition", SqlDbType.NVarChar, 1000, commonCondition),
            ...
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteScalar(CommandType.StoredProcedure,
                                                                   string.Format("{0}getsearchmallproductcount", RDBSHelper.RDBSTablePre),
                                                                   parms));
        }
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        public IDataReader GetStoreClassProductList(int pageSize, int pageNumber, string commonCondition, string sort)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@pagesize", SqlDbType.Int, 4, pageSize),
                                        GenerateInParam("@pagenumber", SqlDbType.Int, 4, pageNumber),
            ...
            return RDBSHelper.ExecuteReader(CommandType.StoredProcedure,
                                            string.Format("{0}getstoreclassproductlist", RDBSHelper.RDBSTablePre),
                                            parms);
        }
        ...
        /// <param name="commonCondition">普通条件</param>
        /// <returns></returns>
        public int GetStoreClassProductCount(string commonCondition)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@commoncondition", SqlDbType.NVarChar, 1000, commonCondition)
                                    };
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteScalar(CommandType.StoredProcedure,
                                                                   string.Format("{0}getstoreclassproductcount", RDBSHelper.RDBSTablePre),
                                                                   parms));
        }
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        public IDataReader SearchStoreProducts(int pageSize, int pageNumber, string keyword, string commonCondition, string sort)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@pagesize", SqlDbType.Int, 4, pageSize),
                                        GenerateInParam("@pagenumber", SqlDbType.Int, 4, pageNumber),
            ...
            return RDBSHelper.ExecuteReader(CommandType.StoredProcedure,
                                            string.Format("{0}searchstoreproducts", RDBSHelper.RDBSTablePre),
                                            parms);
        }
        ...
        /// <param name="commonCondition">普通条件</param>
        /// <returns></returns>
        public int GetSearchStoreProductCount(string keyword, string commonCondition)
        {
            DbParameter[] parms =  { 
                                        GenerateInParam("@keyword", SqlDbType.NChar, 20, keyword),
                                        GenerateInParam("@commoncondition", SqlDbType.NVarChar, 1000, commonCondition)
            ...
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteScalar(CommandType.StoredProcedure,
                                                                   string.Format("{0}getsearchstoreproductcount", RDBSHelper.RDBSTablePre),
                                                                   parms));
        }
        ...
        public bool UpdateProductAttribute(ProductAttributeInfo productAttributeInfo)
        {
            ...
            string commandText = string.Format("UPDATE [{0}productattributes] SET [attrvalueid]=@attrvalueid,[inputvalue]=@inputvalue WHERE [recordid]=@recordid",
                                                RDBSHelper.RDBSTablePre);
        ...
        /// </summary>
        /// <returns></returns>
        public int GetMaxSKUGid()
        {
            string commandText = string.Format("SELECT MAX([skugid]) FROM [{0}productskus]",
                                                RDBSHelper.RDBSTablePre);
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteScalar(CommandType.Text, commandText));
        }
        ...
        {
            DbParameter[] parms = {
                                        GenerateInParam("@keyword", SqlDbType.NChar,20,productKeywordInfo.Keyword),
        ...
        /// <param name="keyword">关键词</param>
        /// <returns></returns>
        public IDataReader GetCategoryListByKeyword(string keyword)
        {
            DbParameter[] parms = {
                                    GenerateInParam("@keyword", SqlDbType.NChar,20,keyword)
                                   };
        ...
        /// <param name="keyword">关键词</param>
        /// <returns></returns>
        public IDataReader GetCategoryBrandListByKeyword(int cateId, string keyword)
        {
            DbParameter[] parms = {
        ...
        /// <param name="keywordId">关键词id</param>
        /// <returns></returns>
        public int GetPidByKeywordId(int keywordId)
        {
            DbParameter[] parms = {
                                    GenerateInParam("@keywordid", SqlDbType.Int,4,keywordId)
                                   };
            string commandText = string.Format("SELECT [pid] FROM [{0}productkeywords] WHERE [keywordid]=@keywordid", RDBSHelper.RDBSTablePre);
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteDataset(CommandType.Text, commandText, parms));
        }
        ...
        /// <param name="keywordIdList">关键词id列表</param>
        /// <returns></returns>
        public DataTable GetStoreIdListByKeywordId(string keywordIdList)
        {
            string commandText = string.Format("SELECT DISTINCT [storeid] FROM [{0}products] WHERE [pid] IN (SELECT [pid] FROM [{0}productkeywords] WHERE [keywordid] IN (1))",
                                               RDBSHelper.RDBSTablePre,
                                               keywordIdList);
            return RDBSHelper.ExecuteDataset(CommandType.Text, commandText).Tables[0];
        }
        ...
        /// <returns></returns>
        public IDataReader GetRelateProductMainPidList(string relatePidList)
        {
            string commandText = string.Format("SELECT [pid] FROM [{0}relateproducts] WHERE [relatepid] IN ({1})",
                                                RDBSHelper.RDBSTablePre,
                                                relatePidList);
            return RDBSHelper.ExecuteReader(CommandType.Text, commandText);
        }
        ...
        public void AddProductStat(int pid, string category, string value)
        {
            DbParameter[] parms = {
									GenerateInParam("@pid",SqlDbType.Int,4, pid),
        ...
        /// </summary>
        /// <param name="condition">条件</param>
        public int UpdateProductStat(string condition)
        {
        ...
        /// <param name="sort">排序</param>
        /// <returns></returns>
        public DataTable AdminGetProductConsultList(int pageSize, int pageNumber, string condition, string sort)
        {
            bool noCondition = string.IsNullOrWhiteSpace(condition);
            string commandText;
            if (pageNumber == 1)
            {
                if (noCondition)
                    ...
                    commandText = string.Format("SELECT [temp1].[consultid],[temp1].[pid],[temp1].[consulttypeid],[temp1].[state],[temp1].[consultuid],[temp1].[replyuid],[temp1].[storeid],[temp1].[consulttime],[temp1].[replytime],[temp1].[consultmessage],[temp1].[replymessage],[temp1].[consultnickname],[temp1].[replynickname],[temp1].[pname],[temp1].[pshowimg],[temp1].[consultip],[temp1].[replyip],[temp2].[name] AS [sname] FROM (SELECT TOP {0} {1} FROM [{2}productconsults] WHERE {4} ORDER BY {3}) AS [temp1] LEFT JOIN [{2}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                pageSize,
                                                RDBSFields.PRODUCT_CONSULTS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[consultid],[temp1].[pid],[temp1].[consulttypeid],[temp1].[state],[temp1].[consultuid],[temp1].[replyuid],[temp1].[storeid],[temp1].[consulttime],[temp1].[replytime],[temp1].[consultmessage],[temp1].[replymessage],[temp1].[consultnickname],[temp1].[replynickname],[temp1].[pname],[temp1].[pshowimg],[temp1].[consultip],[temp1].[replyip],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {3} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}productconsults]) AS [temp] WHERE [temp].[rowid] BETWEEN {4} AND {3}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.PRODUCT_CONSULTS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                pageNumber * pageSize,
                    ...
                    commandText = string.Format("SELECT [temp1].[consultid],[temp1].[pid],[temp1].[consulttypeid],[temp1].[state],[temp1].[consultuid],[temp1].[replyuid],[temp1].[storeid],[temp1].[consulttime],[temp1].[replytime],[temp1].[consultmessage],[temp1].[replymessage],[temp1].[consultnickname],[temp1].[replynickname],[temp1].[pname],[temp1].[pshowimg],[temp1].[consultip],[temp1].[replyip],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {3} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}productconsults] WHERE {5}) AS [temp] WHERE [temp].[rowid] BETWEEN {4} AND {3}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.PRODUCT_CONSULTS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                pageNumber * pageSize,
        ...
        /// <returns></returns>
        public string AdminGetProductConsultListCondition(int storeId, int pid, int uid, string consultMessage, string consultStartTime, string consultEndTime)
        {
            StringBuilder condition = new StringBuilder();
        ...
        public DataTable AdminGetProductReviewList(int pageSize, int pageNumber, string condition, string sort)
        {
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[reviewid],[temp1].[pid],[temp1].[uid],[temp1].[oprid],[temp1].[oid],[temp1].[parentid],[temp1].[state],[temp1].[storeid],[temp1].[star],[temp1].[quality],[temp1].[message],[temp1].[reviewtime],[temp1].[pname],[temp1].[pshowimg],[temp1].[buytime],[temp1].[ip],[temp2].[nickname],[temp3].[name] AS [sname] FROM (SELECT TOP {0} {3} FROM [{1}productreviews] ORDER BY {2}) AS [temp1] LEFT JOIN [{1}users] AS [temp2] ON [temp1].[uid]=[temp2].[uid] LEFT JOIN [{1}stores] AS [temp3] ON [temp1].[storeid]=[temp3].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                RDBSFields.PRODUCT_REVIEWS);
                else
                    commandText = string.Format("SELECT [temp1].[reviewid],[temp1].[pid],[temp1].[uid],[temp1].[oprid],[temp1].[oid],[temp1].[parentid],[temp1].[state],[temp1].[storeid],[temp1].[star],[temp1].[quality],[temp1].[message],[temp1].[reviewtime],[temp1].[pname],[temp1].[pshowimg],[temp1].[buytime],[temp1].[ip],[temp2].[nickname],[temp3].[name] AS [sname] FROM (SELECT TOP {0} {4} FROM [{1}productreviews] WHERE {3} ORDER BY {2}) AS [temp1] LEFT JOIN [{1}users] AS [temp2] ON [temp1].[uid]=[temp2].[uid] LEFT JOIN [{1}stores] AS [temp3] ON [temp1].[storeid]=[temp3].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                condition,
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[reviewid],[temp1].[pid],[temp1].[uid],[temp1].[oprid],[temp1].[oid],[temp1].[parentid],[temp1].[state],[temp1].[storeid],[temp1].[star],[temp1].[quality],[temp1].[message],[temp1].[reviewtime],[temp1].[pname],[temp1].[pshowimg],[temp1].[buytime],[temp1].[ip],[temp2].[nickname],[temp3].[name] AS [sname] FROM ((SELECT TOP {3} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}productreviews]) AS [temp] WHERE [temp].[rowid] BETWEEN {4} AND {3}) AS [temp1] LEFT JOIN [{1}users] AS [temp2] ON [temp1].[uid]=[temp2].[uid] LEFT JOIN [{1}stores] AS [temp3] ON [temp1].[storeid]=[temp3].[storeid]",
                                                RDBSFields.PRODUCT_REVIEWS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                pageNumber * pageSize,
                    ...
                    commandText = string.Format("SELECT [temp1].[reviewid],[temp1].[pid],[temp1].[uid],[temp1].[oprid],[temp1].[oid],[temp1].[parentid],[temp1].[state],[temp1].[storeid],[temp1].[star],[temp1].[quality],[temp1].[message],[temp1].[reviewtime],[temp1].[pname],[temp1].[pshowimg],[temp1].[buytime],[temp1].[ip],[temp2].[nickname],[temp3].[name] AS [sname] FROM ((SELECT TOP {3} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}productreviews] WHERE {5}) AS [temp] WHERE [temp].[rowid] BETWEEN {4} AND {3}) AS [temp1] LEFT JOIN [{1}users] AS [temp2] ON [temp1].[uid]=[temp2].[uid] LEFT JOIN [{1}stores] AS [temp3] ON [temp1].[storeid]=[temp3].[storeid]",
                                                RDBSFields.PRODUCT_REVIEWS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                pageNumber * pageSize,
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        public DataTable GetProductReviewList(int pid, int pageSize, int pageNumber)
        {
            DbParameter[] parms = {
                                    GenerateInParam("@pid", SqlDbType.Int,4,pid),
                                    GenerateInParam("@pagesize", SqlDbType.Int,4,pageSize),
        ...
        /// <param name="pid">商品id</param>
        /// <returns></returns>
        public int GetProductReviewCount(int pid)
        {
            DbParameter[] parms = {
                                    GenerateInParam("@pid", SqlDbType.Int,4,pid)
                                    };

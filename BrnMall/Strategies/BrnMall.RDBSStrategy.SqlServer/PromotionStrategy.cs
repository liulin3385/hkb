...
namespace BrnMall.RDBSStrategy.SqlServer
{
    ...
    public partial class RDBSStrategy : IRDBSStrategy
    {
        ...
        public int AdminIsExistSinglePromotion(int pid, DateTime startTime, DateTime endTime)
        {
            ...
            string commandText = string.Format(@"SELECT [pmid] FROM [{0}singlepromotions] WHERE [pid]=@pid AND 
        ...
        public DataTable AdminGetBuySendPromotionList(int pageSize, int pageNumber, string condition, string sort)
        {
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name] AS [pname],[temp1].[type],[temp1].[buycount],[temp1].[sendcount],[temp2].[name] AS [sname] FROM (SELECT TOP {0} {3} FROM [{1}buysendpromotions] ORDER BY {2}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                RDBSFields.BUYSEND_PROMOTIONS);
                    ...
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name] AS [pname],[temp1].[type],[temp1].[buycount],[temp1].[sendcount],[temp2].[name] AS [sname] FROM (SELECT TOP {0} {4} FROM [{1}buysendpromotions] WHERE {3} ORDER BY {2}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                condition,
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name] AS [pname],[temp1].[type],[temp1].[buycount],[temp1].[sendcount],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}buysendpromotions]) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.BUYSEND_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                    ...
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name] AS [pname],[temp1].[type],[temp1].[buycount],[temp1].[sendcount],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}buysendpromotions] WHERE {5}) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.BUYSEND_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,
        ...
        public int AdminIsExistGiftPromotion(int pid, DateTime startTime, DateTime endTime)
        {
            ...
            string commandText = string.Format(@"SELECT [pmid] FROM [{0}giftpromotions] WHERE [pid]=@pid AND 
                                                (([starttime1]<=@starttime AND [endtime1]>@starttime) OR ([starttime2]<=@starttime AND [endtime2]>@starttime) OR ([starttime3]<=@starttime AND [endtime3]>@starttime)
                                                OR ([starttime1]<=@endtime AND [endtime1]>@endtime) OR ([starttime2]<=@endtime AND [endtime2]>@endtime) OR ([starttime3]<=@endtime AND [endtime3]>@endtime))",
                                                RDBSHelper.RDBSTablePre);
            return TypeHelper.ObjectToInt(RDBSHelper.ExecuteScalar(CommandType.Text, commandText, parms));
        ...
        public void AddGift(int pmId, int giftId, int number)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@pmid", SqlDbType.Int, 4, pmId),
            ...
            string commandText = string.Format("INSERT INTO [{0}gifts]([pmid],[giftid],[number]) VALUES(@pmid,@giftid,@number)",
                                                RDBSHelper.RDBSTablePre);
            RDBSHelper.ExecuteNonQuery(CommandType.Text, commandText, parms);
        }
        ...
        /// <param name="pmId">促销活动id</param>
        /// <returns></returns>
        public DataTable AdminGetGiftListByPmId(int pmId)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@pmid", SqlDbType.Int,4,pmId)
                                    };
            string commandText = string.Format("SELECT [temp1].[recordid],[temp1].[pmid],[temp1].[giftid],[temp1].[number],[temp2].[name],[temp2].[shopprice] FROM (SELECT {1} FROM [{0}gifts] WHERE [pmid]=@pmid) AS [temp1] LEFT JOIN [{0}products] AS [temp2] ON [temp1].[giftid]=[temp2].[pid]",
                                                RDBSHelper.RDBSTablePre,
                                                RDBSFields.GIFTS);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        public DataTable GetGiftList(int pid, DateTime nowTime)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@pid", SqlDbType.Int, 4, pid),
                                        GenerateInParam("@nowtime", SqlDbType.DateTime, 8, nowTime)
            ...
            return RDBSHelper.ExecuteDataset(CommandType.StoredProcedure,
                                             string.Format("{0}getgiftlist", RDBSHelper.RDBSTablePre),
                                             parms).Tables[0];
        }
        ...
        public DataTable AdminGetSuitPromotionList(int pageSize, int pageNumber, string condition, string sort)
        {
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime1],[temp1].[endtime1],[temp1].[state],[temp1].[name] AS [pname],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}suitpromotions]) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.SUIT_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,
                    ...
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime1],[temp1].[endtime1],[temp1].[state],[temp1].[name] AS [pname],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}suitpromotions] WHERE {5}) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.SUIT_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,
        ...
        /// <returns></returns>
        public bool UpdateSuitProductDiscountValue(int pmId, int pid, int discount)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@pmid", SqlDbType.Int, 4, pmId),
                                        GenerateInParam("@pid", SqlDbType.Int,4,pid),
        ...
        /// <param name="pmId">促销活动id</param>
        /// <returns></returns>
        public DataTable GetSuitProductList(int pmId)
        {
            DbParameter[] parms = {
                                     GenerateInParam("@pmid", SqlDbType.Int,4,pmId)
                                    };
            return RDBSHelper.ExecuteDataset(CommandType.StoredProcedure,
                                             string.Format("{0}getsuitproductlistbypmid", RDBSHelper.RDBSTablePre),
                                             parms).Tables[0];
        }
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        public DataTable GetSuitProductList(int storeId, int pid, DateTime nowTime)
        {
            DbParameter[] parms = {
                                        GenerateInParam("@storeid", SqlDbType.Int, 4, storeId),
                                        GenerateInParam("@nowtime", SqlDbType.DateTime, 8, nowTime),
            ...
            return RDBSHelper.ExecuteDataset(CommandType.StoredProcedure,
                                             string.Format("{0}getsuitproductlistbypidandtime", RDBSHelper.RDBSTablePre),
                                             parms).Tables[0];
        }
        ...
        public DataTable AdminGetFullSendPromotionList(int pageSize, int pageNumber, string condition, string sort)
        {
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[state],[temp1].[name],[temp1].[limitmoney],[temp1].[addmoney],[temp2].[name] AS [sname] FROM (SELECT TOP {0} [pmid],[storeid],[starttime],[endtime],[state],[name],[limitmoney],[addmoney] FROM [{1}fullsendpromotions] ORDER BY {2}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort);

                else
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[state],[temp1].[name],[temp1].[limitmoney],[temp1].[addmoney],[temp2].[name] AS [sname] FROM (SELECT TOP {0} [pmid],[storeid],[starttime],[endtime],[state],[name],[limitmoney],[addmoney] FROM [{1}fullsendpromotions] WHERE {3} ORDER BY {2}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                condition);
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[state],[temp1].[name],[temp1].[limitmoney],[temp1].[addmoney],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}fullsendpromotions]) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.FULLSEND_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,
                    ...
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[starttime],[temp1].[endtime],[temp1].[state],[temp1].[name],[temp1].[limitmoney],[temp1].[addmoney],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}fullsendpromotions] WHERE {5}) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.FULLSEND_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,
        ...
        public DataTable AdminGetFullCutPromotionList(int pageSize, int pageNumber, string condition, string sort)
        {
            ...
            if (pageNumber == 1)
            {
                if (noCondition)
                    ...
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[type],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name],[temp1].[limitmoney1],[temp1].[cutmoney1],[temp1].[limitmoney2],[temp1].[cutmoney2],[temp1].[limitmoney3],[temp1].[cutmoney3],[temp2].[name] AS [sname] FROM (SELECT TOP {0} {4} FROM [{1}fullcutpromotions] WHERE {3} ORDER BY {2}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                pageSize,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                condition,
            ...
            {
                if (noCondition)
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[type],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name],[temp1].[limitmoney1],[temp1].[cutmoney1],[temp1].[limitmoney2],[temp1].[cutmoney2],[temp1].[limitmoney3],[temp1].[cutmoney3],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}fullcutpromotions]) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.FULLCUT_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,
                    ...
                    commandText = string.Format("SELECT [temp1].[pmid],[temp1].[storeid],[temp1].[type],[temp1].[starttime],[temp1].[endtime],[temp1].[userranklower],[temp1].[state],[temp1].[name],[temp1].[limitmoney1],[temp1].[cutmoney1],[temp1].[limitmoney2],[temp1].[cutmoney2],[temp1].[limitmoney3],[temp1].[cutmoney3],[temp2].[name] AS [sname] FROM (SELECT {0} FROM (SELECT TOP {4} ROW_NUMBER() OVER (ORDER BY {2}) AS [rowid],{0} FROM [{1}fullcutpromotions] WHERE {5}) AS [temp] WHERE [temp].[rowid] BETWEEN {3} AND {4}) AS [temp1] LEFT JOIN [{1}stores] AS [temp2] ON [temp1].[storeid]=[temp2].[storeid]",
                                                RDBSFields.FULLCUT_PROMOTIONS,
                                                RDBSHelper.RDBSTablePre,
                                                sort,
                                                (pageNumber - 1) * pageSize + 1,

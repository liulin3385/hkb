...
namespace BrnMall.Web.StoreAdmin.Controllers
{
    ...
    /// 店铺后台促销活动控制器类
    /// </summary>
    public class PromotionController : BaseStoreAdminController
    {
        /// <summary>
        /// 单品促销活动列表
        /// </summary>
        ...
        public ActionResult SinglePromotionList(string productName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
            ...
            MallUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&sortColumn={3}&sortDirection={4}&pid={5}&productName={6}&promotionName={7}&promotionTime={8}",
        ...
        public ActionResult BuySendPromotionList(string promotionName, string promotionTime, string sortColumn, string sortDirection, int pageSize = 15, int pageNumber = 1)
        {
            ...
            MallUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&sortColumn={3}&sortDirection={4}&promotionName={5}&promotionTime={6}",

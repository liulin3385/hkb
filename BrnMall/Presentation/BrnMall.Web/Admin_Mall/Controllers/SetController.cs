...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台系统设置控制器类
    /// </summary>
    public class SetController : BaseMallAdminController
    {
        /// <summary>
        /// 站点设置
        /// </summary>
        ...
        public ActionResult Site(SiteModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.MallName = model.MallName == null ? "" : model.MallName.Trim();
                mallConfigInfo.SiteUrl = model.SiteUrl == null ? "" : model.SiteUrl.Trim();
                mallConfigInfo.SiteTitle = model.SiteTitle == null ? "" : model.SiteTitle.Trim();
                mallConfigInfo.SEOKeyword = model.SEOKeyword == null ? "" : model.SEOKeyword.Trim();
                mallConfigInfo.SEODescription = model.SEODescription == null ? "" : model.SEODescription.Trim();
                mallConfigInfo.ICP = model.ICP == null ? "" : model.ICP.Trim();
                mallConfigInfo.Script = model.Script == null ? "" : model.Script.Trim();
        ...
        public ActionResult Upload()
        {
            ...
            model.UploadAttType = mallConfigInfo.UploadAttType;
            model.UploadAttSize = mallConfigInfo.UploadAttSize / 1000;
            ...
            model.FriendLinkThumbSize = mallConfigInfo.FriendLinkThumbSize;
        ...
        public ActionResult Upload(UploadModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.UploadAttType = model.UploadAttType;
                mallConfigInfo.UploadAttSize = model.UploadAttSize * 1000;
                ...
                mallConfigInfo.WatermarkImg = model.WatermarkImg == null ? "" : model.WatermarkImg.Trim();
                mallConfigInfo.WatermarkImgOpacity = model.WatermarkImgOpacity;
                mallConfigInfo.WatermarkText = model.WatermarkText == null ? "" : model.WatermarkText.Trim();
                ...
                mallConfigInfo.FriendLinkThumbSize = model.FriendLinkThumbSize;
        ...
        public ActionResult Performance()
        {
            ...
            model.UpdatePVStatTimespan = mallConfigInfo.UpdatePVStatTimespan;
        ...
        public ActionResult Performance(PerformanceModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.ImageCDN = model.ImageCDN == null ? "" : model.ImageCDN.Trim();
                mallConfigInfo.CSSCDN = model.CSSCDN == null ? "" : model.CSSCDN.Trim();
                mallConfigInfo.ScriptCDN = model.ScriptCDN == null ? "" : model.ScriptCDN.Trim();
                ...
                mallConfigInfo.UpdatePVStatTimespan = model.UpdatePVStatTimespan;
        ...
        public ActionResult Access(AccessModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.CookieDomain = model.CookieDomain == null ? "" : model.CookieDomain.Trim().Trim('.');
                mallConfigInfo.RandomLibrary = model.RandomLibrary == null ? "" : model.RandomLibrary.Trim();
        ...
        public ActionResult Email(EmailModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                emailConfigInfo.Host = model.Host.Trim();
                emailConfigInfo.Port = model.Port;
                emailConfigInfo.From = model.From.Trim();
                emailConfigInfo.FromName = model.FromName.Trim();
                emailConfigInfo.UserName = model.UserName.Trim();
                emailConfigInfo.Password = model.Password.Trim();
        ...
        public ActionResult SMS(SMSModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                smsConfigInfo.Url = model.Url.Trim();
                smsConfigInfo.UserName = model.UserName.Trim();
                smsConfigInfo.Password = model.Password.Trim();
        ...
        public ActionResult Mall()
        {
            ...
            model.OfflinePayExpire = mallConfigInfo.OfflinePayExpire;
        ...
        public ActionResult Mall(MallModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.OfflinePayExpire = model.OfflinePayExpire;

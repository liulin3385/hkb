...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台促销活动控制器类
    /// </summary>
    public class PromotionController : BaseMallAdminController
    {
        /// <summary>
        /// 单品促销活动列表
        /// </summary>
        ...
        /// <returns></returns>
        public ActionResult SinglePromotionList(string storeName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int storeId = -1, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
            ...
            MallUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&sortColumn={3}&sortDirection={4}&storeId={5}&storeName={6}&pid={7}&promotionName={8}&promotionTime={9}",
        ...
        public ActionResult AddSinglePromotion(SinglePromotionModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SinglePromotionInfo singlePromotionInfo = new SinglePromotionInfo()
                {
                    ...
                    State = model.State,
                    Name = model.PromotionName.Trim(),
                    Slogan = model.Slogan == null ? "" : model.Slogan.Trim(),
        ...
        public ActionResult EditSinglePromotion(SinglePromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                singlePromotionInfo.Name = model.PromotionName.Trim();
                singlePromotionInfo.Slogan = model.Slogan == null ? "" : model.Slogan.Trim();
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult BuySendPromotionList(string storeName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int storeId = -1, int pageSize = 15, int pageNumber = 1)
        {
            ...
            MallUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&sortColumn={3}&sortDirection={4}&storeId={5}&storeName={6}&promotionName={7}&promotionTime={8}",
        ...
        public ActionResult EditBuySendPromotion(BuySendPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                buySendPromotionInfo.Name = model.PromotionName.Trim();
        ...
        /// <param name="pid">商品id</param>
        /// <returns></returns>
        public ActionResult GiftPromotionList(string storeName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int storeId = -1, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
        ...
        public ActionResult EditGiftPromotion(GiftPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                giftPromotionInfo.Name = model.PromotionName.Trim();
        ...
        public ActionResult GiftList(int pmId = -1)
        {
            ...
            {
                GiftList = AdminPromotions.AdminGetGiftListByPmId(pmId),
                PmId = pmId,
        ...
        public ActionResult AddGift(int pmId = -1, int giftId = -1, int number = -1)
        {
            ...
            AdminPromotions.AddGift(pmId, giftId, number);
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult SuitPromotionList(string storeName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int storeId = -1, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
        ...
        public ActionResult EditSuitPromotion(SuitPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                suitPromotionInfo.Name = model.PromotionName.Trim();
        ...
        public ActionResult SuitProductList(int pmId = -1)
        {
            ...
            {
                SuitProductList = AdminPromotions.GetSuitProductList(pmId),
                PmId = pmId,
        ...
        {
            bool result = AdminPromotions.UpdateSuitProductDiscountValue(pmId, pid, discount);
            if (result)
            {
        ...
        /// 满赠促销活动列表
        /// </summary>
        public ActionResult FullSendPromotionList(string storeName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int storeId = -1, int pageSize = 15, int pageNumber = 1)
        {
        ...
        public ActionResult EditFullSendPromotion(FullSendPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                fullSendPromotionInfo.Name = model.PromotionName.Trim();
                //fullSendPromotionInfo.Pid = model.Pid;
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult FullCutPromotionList(string storeName, string promotionName, string promotionTime, string sortColumn, string sortDirection, int storeId = -1, int pageSize = 15, int pageNumber = 1)
        {
        ...
        public ActionResult EditFullCutPromotion(FullCutPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                fullCutPromotionInfo.Name = model.PromotionName.Trim();

...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城配送公司控制器类
    /// </summary>
    public class ShipCompanyController : BaseMallAdminController
    {
        /// <summary>
        /// 配送公司列表
        /// </summary>
        ...
        {
            if (model.CompanyName != null && AdminShipCompanies.GetShipCoIdByName(model.CompanyName) > 0)
        ...
        public ActionResult Edit(ShipCompanyModel model, int shipCoId = -1)
        {
            ...
            {
                int shipCoId2 = AdminShipCompanies.GetShipCoIdByName(model.CompanyName.Trim());
            ...
            if (ModelState.IsValid)
            {
                ...
                shipCompanyInfo.Name = model.CompanyName.Trim();

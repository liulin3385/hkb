...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台商品咨询控制器类
    /// </summary>
    public class ProductConsultController : BaseMallAdminController
    {
        /// <summary>
        /// 商品咨询类型列表
        /// </summary>
        ...
        public ActionResult EditProductConsultType(ProductConsultTypeModel model, int consultTypeId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                productConsultTypeInfo.Title = model.Title.Trim();
        ...
        {
            AdminProductConsults.DeleteProductConsultTypeById(consultTypeId);
        ...
        {
            string condition = AdminProductConsults.AdminGetProductConsultListCondition(storeId, pid, 0, consultMessage, consultStartTime, consultEndTime);

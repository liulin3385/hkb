...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台banner控制器类
    /// </summary>
    public class BannerController : BaseMallAdminController
    {
        /// <summary>
        /// banner列表
        /// </summary>
        ...
        public ActionResult Add(BannerModel model)
        {
            if (ModelState.IsValid)
            {
                BannerInfo bannerInfo = new BannerInfo()
                {
                    ...
                    IsShow = model.IsShow,
                    Title = model.BannerTitle == null ? "" : model.BannerTitle.Trim(),
                    Img = model.Img.Trim(),
                    Url = model.Url.Trim(),
        ...
        public ActionResult Edit(BannerModel model, int id = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                bannerInfo.Title = model.BannerTitle == null ? "" : model.BannerTitle.Trim();
                bannerInfo.Img = model.Img.Trim();
                bannerInfo.Url = model.Url.Trim();

...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台新闻控制器类
    /// </summary>
    public class NewsController : BaseMallAdminController
    {
        /// <summary>
        /// 新闻类型列表
        /// </summary>
        ...
        {
            if (model.NewsTypeName != null && AdminNews.GetNewsTypeByName(model.NewsTypeName.Trim()) != null)
        ...
        public ActionResult EditNewsType(NewsTypeModel model, int newsTypeId = -1)
        {
            ...
            if (model.NewsTypeName != null)
            {
                NewsTypeInfo newsTypeInfo2 = AdminNews.GetNewsTypeByName(model.NewsTypeName.Trim());
            ...
            if (ModelState.IsValid)
            {
                newsTypeInfo.Name = model.NewsTypeName.Trim();
        ...
        {
            if (model.Title != null && AdminNews.AdminGetNewsIdByTitle(model.Title.Trim()) > 0)
            ...
            if (ModelState.IsValid)
            {
                NewsInfo newsInfo = new NewsInfo()
                {
                    ...
                    Url = model.Url == null ? "" : model.Url.Trim(),
                    Body = model.Body ?? ""
                };
        ...
        public ActionResult EditNews(NewsModel model, int newsId = -1)
        {
            ...
            if (model.Title != null)
            {
                int newsId2 = AdminNews.AdminGetNewsIdByTitle(model.Title.Trim());
            ...
            if (ModelState.IsValid)
            {
                ...
                newsInfo.Title = model.Title.Trim();
                newsInfo.Url = model.Url == null ? "" : model.Url.Trim();

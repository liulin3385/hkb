...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台商城帮助控制器类
    /// </summary>
    public class HelpController : BaseMallAdminController
    {
        /// <summary>
        /// 商城帮助列表
        /// </summary>
        ...
        public ActionResult AddHelpCategory(HelpCategoryModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Pid = 0,
                    Title = model.HelpCategoryTitle.Trim(),
                    Url = "",
                    Description = "",
        ...
        public ActionResult EditHelpCategory(HelpCategoryModel model, int id = -1)
        {
            ...
            {
                helpInfo.Pid = 0;
                helpInfo.Title = model.HelpCategoryTitle.Trim();
                helpInfo.Url = "";
        ...
        public ActionResult EditHelp(HelpModel model, int id = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                helpInfo.Title = model.HelpTitle.Trim();
                helpInfo.Url = model.Url == null ? "" : model.Url.Trim();

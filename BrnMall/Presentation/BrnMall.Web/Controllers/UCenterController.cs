...
namespace BrnMall.Web.Controllers
{
    ...
    /// 用户中心控制器类
    /// </summary>
    public class UCenterController : BaseWebController
    {
        #region 用户信息
        ...
        public ActionResult EditUser()
        {
            ...
            {
                errorList.AppendFormat("{0}\"key\":\"{1}\",\"msg\":\"{2}\"{3},", "{", "nickName", "请输入昵称", "}");
            }
            ...
            if (errorList.Length == 1)
            {
                ...
                Users.UpdateUser(WorkContext.Uid, userName, nickName, avatar, gender, realName, TypeHelper.StringToDateTime(bday), idCard, regionId, address, bio);
        ...
        public ActionResult UpdatePassword()
        {
            ...
            string url = string.Format("http://{0}{1}", Request.Url.Authority, Url.Action("SafeSuccess", new RouteValueDictionary { { "act", "updatePassword" } }));
            return AjaxResult("success", url);
        }
        ...
        public ActionResult UpdateMobile()
        {
            ...
            string url = string.Format("http://{0}{1}", Request.Url.Authority, Url.Action("SafeSuccess", new RouteValueDictionary { { "act", "updateMobile" } }));
            return AjaxResult("success", url);
        }
        ...
        public ActionResult OrderInfo()
        {
            ...
            model.OrderProductList = AdminOrders.TidyStoreOrderProductList(AdminOrders.GetOrderProductList(oid));
        ...
        public ActionResult ShipAddressInfo()
        {
            ...
            return AjaxResult("success", JSON.ToJSON(fullShipAddressInfo), true);
        }
        ...
        public ActionResult AddShipAddress()
        {
            ...
            if (verifyResult.Length == 0)
            {
                ...
                shipAddressInfo.Address = address;
        ...
        public ActionResult ReviewProduct()
        {
            ...
            OrderProductInfo orderProductInfo = Orders.GetOrderProductByRecordId(recordId);
            if (orderProductInfo == null || orderProductInfo.Uid != WorkContext.Uid)
            ...
            //订单未完成
            int orderState = Orders.GetOrderStateByOid(orderProductInfo.Oid);
            if (orderState != (int)OrderState.Completed)
